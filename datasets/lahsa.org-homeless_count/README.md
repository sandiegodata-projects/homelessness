...
The folowing notes are from the original source Excel file:
...
in cars, vans, campers/RVs, tents, and makeshift shelters. The conversion
factors used to estimate the number of persons found living outside are the
following:  

For families:
- Makeshift Shelter = 2.42,
- Car = 2.96, Van = 2.43 
- Camper/RV = 3.35
- Tent = 2.75

For individuals:
- Makeshift Shelter 1.67
- Car = 1.54
- Van = 1.62
- Camper/RV = 1.76
- Tent = 1.52.
